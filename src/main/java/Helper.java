...
public class Helper {
    ...
    public static void main(String[] args) throws IOException{
        ...
        BufferedReader pr = new BufferedReader(new FileReader("/Users/jianyishi/src/pr30.txt"));
        BufferedReader transition = new BufferedReader(new FileReader("/Users/jianyishi/src/Project3/Project3-2/src/main/java/transition.txt"));
        FileWriter fileWriter = new FileWriter("/Users/jianyishi/src/result.csv");
